...
*<p align='right'>"Programming language is not a temple, but a workshop." (c)...</p>*

Void is an open-source, highly extensible programming language, minimalistic and low-level in its base.
Void uses LLVM for code generation and can be seen as a thin (well, in some sense) shell around it.
